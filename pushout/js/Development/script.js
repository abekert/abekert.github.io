...
function deviceMotion(event) {
    ...
    var accX = parseInt(event.accelerationIncludingGravity.x * 10);// Math.round(event.accelerationIncludingGravity.x*10) / 10;  
    var accY = parseInt(event.accelerationIncludingGravity.y * 10);// Math.round(event.accelerationIncludingGravity.y*10) / 10;  
    var accZ = parseInt(event.accelerationIncludingGravity.z * 10);// Math.round(event.accelerationIncludingGravity.y*10) / 10;  
